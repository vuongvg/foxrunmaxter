...
function _CallRequestBuySkin(skinIdPtr, PriceValue) {
 console.log("-=-=CallRequestBuySkin");
 const skinId = UTF8ToString(skinIdPtr);
 CallRequestBuySkin(skinId, PriceValue);
}
...
var asmLibraryArg = {
 "CallRequestBuySkin": _CallRequestBuySkin,
